...
<script>
  ...
  for (let i = 0; i < numBodies; i++) {
    let circle = B.circle(Math.random() * C.clientWidth, Math.random() * C.clientHeight, 39, { friction: .1, frictionAir: 0.00001, restitution: 0.3, render: { sprite: { texture: 'https://uploads-ssl.webflow.com/64f024c208db7bbce63d76ba/64f12d4a6fa1f35dfc487566_ballpit-ball-logo-77px-2.png' } } });
    Cm.add(engine.world, circle);
  }
